...
class AppregistModel {
     ...
     * @return void
     */
     protected function checkNoEmpty(array &$msg, object $data)   {
        if ($data->domain == '') {
      ...
      * @param object $data
      */
     protected function adjustData(object &$data) {
         if ($data->psw1 != '') {
      ...
      * @return void
      */
     protected function updateAfterInsert(object &$data, object &$table, array &$msg) {
