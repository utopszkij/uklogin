	...
	public function display($p) {
        ...
        <body ng-app="app">
          ...
          <div ng-controller="ctrl" id="scope" style="display:block; padding:20px;">
            ...
            <p>Jelen leírás az ügyfélkapú segitségével történő felhasználó regisztrációt és
            ...
            <p>A szoftver müködésének testreszabásához, az egyes müködési munkamenetek 
            szervezéséhez egy daram un "munkaement cookie"-t használ amit a felhasználó
            gépén tárol. Ez a cookie személyes adatokat nem tartalmaz, tartalmából 
            minössze annyit lehet megállapítani, hogy a felhasználó használja/használta
            ezt a rendszert.</p>
            ...
            <li>access_token - az oAuth2 eljárás során használt ideiglenes, egszer használható technikai azonosító</li>
            ...
            <p>
            A felhasználó sikeres bejelentkezés után json formátumban megtekinthei/letöltheti a róla az adott applikációval kapcsolatban
            tárolt adatoka. Továbbá lehetősége van adatainak (és ezzel bejelentkezési lehetőségének) törlésére is. 	
            </p> 
            <p>A regisztrációs folyamat során fel kell tölteni egy a https://niszavdh.gov.hu segitségével aláírt 
            ...
            <p>Az adminisztrátor sikeres bejelentkezése után az képernyőn láthatják
            ...
            és kezelése érdekében. Mindent megtesznek addak érdekében, hogy az adatok illetéktelen kezekbe
            ne kerülhessenek.</p>
            <p>A tárolt adatokat harmadik félnek csak abban az esetben adja át, ha erre őket törvény kötelezi.</p>
            <p>Adatkezelő: Fogler Tibor Adatok technikai tárolása: Forpsi.hu</p>
	      </div><!-- #scope -->
		  <?php $this->echoFooter(); ?>
        </body>
        </html>
